...
- [ ] **UC4.4 - Acorazado**: Bombardeo en zona (Cruz 5 casillas).
- [ ] **UC4.5 - Destructor**: Disparo doble (Acción extra).
...
| :----------------------------------- | :----------------- | :-------: |
| `Componente` (Estructura abstracta)  |                    |    [ ]    |
...
_Describe aquí los problemas técnicos más importantes que habéis tenido (ej: problemas con el polimorfismo, manejo de excepciones al parsear coordenadas, etc.) y cómo los habéis resuelto._
...
_Reflexión sobre el uso de la Programación Orientada a Objetos en este proyecto:_

- **Herencia vs Composición**: ¿Por qué usamos composición para el blindaje y herencia para los barcos?
- **Polimorfismo**: ¿Cómo ha facilitado el uso de habilidades especiales en el bucle del juego?
- **Encapsulamiento**: ¿De qué sirve ocultar los atributos y usar getters/setters?
